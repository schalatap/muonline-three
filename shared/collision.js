/**
 * shared/collision.js - Sistema unificado de colisão compartilhado entre cliente e servidor
 */
...
// Gerenciador de colisão global, compartilhado entre servidor e cliente
let serverCollisionManager = null;

// Função para obter o gerenciador de colisões apropriado
function getCollisionManager() {
  // No ambiente Node.js
  if (typeof module !== 'undefined' && module.exports) {
    if (!serverCollisionManager) {
      serverCollisionManager = new CollisionManager();
    }
    return serverCollisionManager;
  }
  
  // No navegador
  if (typeof window !== 'undefined' && window.CollisionSystem) {
    return window.CollisionSystem.collisionManager;
  }
  
  // Fallback: criar um novo gerenciador
  console.warn("Criando novo gerenciador de colisão. Isso pode indicar um problema de inicialização.");
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    ...
    getCollisionManager,
    serverCollisionManager: getCollisionManager()
  };
